...
// extern gboolean _gotk4_gtksource3_UndoManagerIface_can_redo(GtkSourceUndoManager*);
// extern gboolean _gotk4_gtksource3_UndoManagerIface_can_undo(GtkSourceUndoManager*);
// extern void _gotk4_gtksource3_UndoManagerIface_begin_not_undoable_action(GtkSourceUndoManager*);
// extern void _gotk4_gtksource3_UndoManagerIface_can_redo_changed(GtkSourceUndoManager*);
// extern void _gotk4_gtksource3_UndoManagerIface_can_undo_changed(GtkSourceUndoManager*);
// extern void _gotk4_gtksource3_UndoManagerIface_end_not_undoable_action(GtkSourceUndoManager*);
// extern void _gotk4_gtksource3_UndoManagerIface_redo(GtkSourceUndoManager*);
// extern void _gotk4_gtksource3_UndoManagerIface_undo(GtkSourceUndoManager*);
...
func ifaceInitUndoManagerer(gifacePtr, data C.gpointer) {
	...
	iface.begin_not_undoable_action = (*[0]byte)(C._gotk4_gtksource3_UndoManagerIface_begin_not_undoable_action)
	iface.can_redo = (*[0]byte)(C._gotk4_gtksource3_UndoManagerIface_can_redo)
	iface.can_redo_changed = (*[0]byte)(C._gotk4_gtksource3_UndoManagerIface_can_redo_changed)
	iface.can_undo = (*[0]byte)(C._gotk4_gtksource3_UndoManagerIface_can_undo)
	iface.can_undo_changed = (*[0]byte)(C._gotk4_gtksource3_UndoManagerIface_can_undo_changed)
	iface.end_not_undoable_action = (*[0]byte)(C._gotk4_gtksource3_UndoManagerIface_end_not_undoable_action)
	iface.redo = (*[0]byte)(C._gotk4_gtksource3_UndoManagerIface_redo)
	iface.undo = (*[0]byte)(C._gotk4_gtksource3_UndoManagerIface_undo)
}

//export _gotk4_gtksource3_UndoManagerIface_begin_not_undoable_action
func _gotk4_gtksource3_UndoManagerIface_begin_not_undoable_action(arg0 *C.GtkSourceUndoManager) {
...
//export _gotk4_gtksource3_UndoManagerIface_can_redo
func _gotk4_gtksource3_UndoManagerIface_can_redo(arg0 *C.GtkSourceUndoManager) (cret C.gboolean) {
	goval := externglib.GoPrivateFromObject(unsafe.Pointer(arg0))
	iface := goval.(UndoManagerOverrider)
...
//export _gotk4_gtksource3_UndoManagerIface_can_redo_changed
func _gotk4_gtksource3_UndoManagerIface_can_redo_changed(arg0 *C.GtkSourceUndoManager) {
	goval := externglib.GoPrivateFromObject(unsafe.Pointer(arg0))
	iface := goval.(UndoManagerOverrider)
...
//export _gotk4_gtksource3_UndoManagerIface_can_undo
func _gotk4_gtksource3_UndoManagerIface_can_undo(arg0 *C.GtkSourceUndoManager) (cret C.gboolean) {
	goval := externglib.GoPrivateFromObject(unsafe.Pointer(arg0))
	iface := goval.(UndoManagerOverrider)
...
//export _gotk4_gtksource3_UndoManagerIface_can_undo_changed
func _gotk4_gtksource3_UndoManagerIface_can_undo_changed(arg0 *C.GtkSourceUndoManager) {
	goval := externglib.GoPrivateFromObject(unsafe.Pointer(arg0))
	iface := goval.(UndoManagerOverrider)
...
//export _gotk4_gtksource3_UndoManagerIface_end_not_undoable_action
func _gotk4_gtksource3_UndoManagerIface_end_not_undoable_action(arg0 *C.GtkSourceUndoManager) {
	goval := externglib.GoPrivateFromObject(unsafe.Pointer(arg0))
	iface := goval.(UndoManagerOverrider)
...
//export _gotk4_gtksource3_UndoManagerIface_redo
func _gotk4_gtksource3_UndoManagerIface_redo(arg0 *C.GtkSourceUndoManager) {
	goval := externglib.GoPrivateFromObject(unsafe.Pointer(arg0))
	iface := goval.(UndoManagerOverrider)
...
//export _gotk4_gtksource3_UndoManagerIface_undo
func _gotk4_gtksource3_UndoManagerIface_undo(arg0 *C.GtkSourceUndoManager) {
	goval := externglib.GoPrivateFromObject(unsafe.Pointer(arg0))
	iface := goval.(UndoManagerOverrider)
...
func (manager *UndoManager) ConnectCanRedoChanged(f func()) externglib.SignalHandle {
	return externglib.ConnectGeneratedClosure(manager, "can-redo-changed", false, unsafe.Pointer(C._gotk4_gtksource3_UndoManager_ConnectCanRedoChanged), f)
}
...
func (manager *UndoManager) ConnectCanUndoChanged(f func()) externglib.SignalHandle {
	return externglib.ConnectGeneratedClosure(manager, "can-undo-changed", false, unsafe.Pointer(C._gotk4_gtksource3_UndoManager_ConnectCanUndoChanged), f)
}
