...
// void _gotk4_gtksource3_CompletionContext_virtual_cancelled(void* fnptr, GtkSourceCompletionContext* arg0) {
...
func (context *CompletionContext) ConnectCancelled(f func()) coreglib.SignalHandle {
	return coreglib.ConnectGeneratedClosure(context, "cancelled", false, unsafe.Pointer(C._gotk4_gtksource3_CompletionContext_ConnectCancelled), f)
}
...
func (context *CompletionContext) cancelled() {
	...
	C._gotk4_gtksource3_CompletionContext_virtual_cancelled(unsafe.Pointer(fnarg), _arg0)
	runtime.KeepAlive(context)
}
