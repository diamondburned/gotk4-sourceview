...
// GtkSourceStyleScheme* _gotk4_gtksource3_StyleSchemeChooser_virtual_get_style_scheme(void* fnptr, GtkSourceStyleSchemeChooser* arg0) {
//   return ((GtkSourceStyleScheme* (*)(GtkSourceStyleSchemeChooser*))(fnptr))(arg0);
// };
// void _gotk4_gtksource3_StyleSchemeChooser_virtual_set_style_scheme(void* fnptr, GtkSourceStyleSchemeChooser* arg0, GtkSourceStyleScheme* arg1) {
...
func (chooser *StyleSchemeChooser) styleScheme() *StyleScheme {
	...
	_cret = C._gotk4_gtksource3_StyleSchemeChooser_virtual_get_style_scheme(unsafe.Pointer(fnarg), _arg0)
	runtime.KeepAlive(chooser)
...
func (chooser *StyleSchemeChooser) setStyleScheme(scheme *StyleScheme) {
	...
	C._gotk4_gtksource3_StyleSchemeChooser_virtual_set_style_scheme(unsafe.Pointer(fnarg), _arg0, _arg1)
	runtime.KeepAlive(chooser)
	runtime.KeepAlive(scheme)
}
