...
// extern void _gotk4_gtksource3_Buffer_ConnectUndo(gpointer, guintptr);
// extern void _gotk4_gtksource3_Buffer_ConnectSourceMarkUpdated(gpointer, GtkTextMark*, guintptr);
// extern void _gotk4_gtksource3_Buffer_ConnectRedo(gpointer, guintptr);
// extern void _gotk4_gtksource3_Buffer_ConnectHighlightUpdated(gpointer, GtkTextIter*, GtkTextIter*, guintptr);
// extern void _gotk4_gtksource3_Buffer_ConnectBracketMatched(gpointer, GtkTextIter*, GtkSourceBracketMatchType, guintptr);
// extern void _gotk4_gtksource3_BufferClass_undo(GtkSourceBuffer*);
// extern void _gotk4_gtksource3_BufferClass_redo(GtkSourceBuffer*);
// extern void _gotk4_gtksource3_BufferClass_bracket_matched(GtkSourceBuffer*, GtkTextIter*, GtkSourceBracketMatchType);
// void _gotk4_gtksource3_Buffer_virtual_bracket_matched(void* fnptr, GtkSourceBuffer* arg0, GtkTextIter* arg1, GtkSourceBracketMatchType arg2) {
//   ((void (*)(GtkSourceBuffer*, GtkTextIter*, GtkSourceBracketMatchType))(fnptr))(arg0, arg1, arg2);
// };
// void _gotk4_gtksource3_Buffer_virtual_redo(void* fnptr, GtkSourceBuffer* arg0) {
//   ((void (*)(GtkSourceBuffer*))(fnptr))(arg0);
// };
// void _gotk4_gtksource3_Buffer_virtual_undo(void* fnptr, GtkSourceBuffer* arg0) {
//   ((void (*)(GtkSourceBuffer*))(fnptr))(arg0);
// };
import "C"
...
func initBufferClass(gclass unsafe.Pointer, overrides BufferOverrides, classInitFunc func(*BufferClass)) {
	...
	if overrides.BracketMatched != nil {
		pclass.bracket_matched = (*[0]byte)(C._gotk4_gtksource3_BufferClass_bracket_matched)
	}

	if overrides.Redo != nil {
		pclass.redo = (*[0]byte)(C._gotk4_gtksource3_BufferClass_redo)
	}

	if overrides.Undo != nil {
		pclass.undo = (*[0]byte)(C._gotk4_gtksource3_BufferClass_undo)
	}
...
func (buffer *Buffer) ConnectBracketMatched(f func(iter *gtk.TextIter, state BracketMatchType)) coreglib.SignalHandle {
	return coreglib.ConnectGeneratedClosure(buffer, "bracket-matched", false, unsafe.Pointer(C._gotk4_gtksource3_Buffer_ConnectBracketMatched), f)
}
...
func (buffer *Buffer) ConnectHighlightUpdated(f func(start, end *gtk.TextIter)) coreglib.SignalHandle {
	return coreglib.ConnectGeneratedClosure(buffer, "highlight-updated", false, unsafe.Pointer(C._gotk4_gtksource3_Buffer_ConnectHighlightUpdated), f)
}

// ConnectRedo signal is emitted to redo the last undo operation.
func (buffer *Buffer) ConnectRedo(f func()) coreglib.SignalHandle {
	return coreglib.ConnectGeneratedClosure(buffer, "redo", false, unsafe.Pointer(C._gotk4_gtksource3_Buffer_ConnectRedo), f)
}
...
func (buffer *Buffer) ConnectSourceMarkUpdated(f func(mark *gtk.TextMark)) coreglib.SignalHandle {
	return coreglib.ConnectGeneratedClosure(buffer, "source-mark-updated", false, unsafe.Pointer(C._gotk4_gtksource3_Buffer_ConnectSourceMarkUpdated), f)
}
...
func (buffer *Buffer) ConnectUndo(f func()) coreglib.SignalHandle {
	return coreglib.ConnectGeneratedClosure(buffer, "undo", false, unsafe.Pointer(C._gotk4_gtksource3_Buffer_ConnectUndo), f)
}
...
// CanRedo determines whether a source buffer can redo the last action (i.e.
// if the last operation was an undo).
//
// The function returns the following values:
//
...
// A source mark is a TextMark but organised into categories. Depending on the
...
// synchronously.
//
// <note> <para> This is a potentially slow operation and should be used
...
// ForwardIterToSourceMark moves iter to the position of the next SourceMark
// of the given category. Returns TRUE if iter was moved. If category is NULL,
...
// Language returns the SourceLanguage associated with the buffer,
...
// StyleScheme returns the SourceStyleScheme associated with the buffer,
// see gtk_source_buffer_set_style_scheme(). The returned object should not be
// unreferenced by the user.
//
// The function returns the following values:
//
...
// UndoManager returns the SourceUndoManager associated with the buffer,
...
func (buffer *Buffer) UndoManager() *UndoManager {
	...
	if _cret != nil {
		_undoManager = wrapUndoManager(coreglib.Take(unsafe.Pointer(_cret)))
	}
...
// returns FALSE, otherwise TRUE. Does not return toggles located at iter,
// only toggles after iter. Sets iter to the location of the toggle, or to the
// end of the buffer if no toggle is found.
//
// See the SourceBuffer description for the list of default context classes.
//
// The function takes the following parameters:
...
// IterForwardToContextClassToggle moves forward to the next toggle (on or
// off) of the context class. If no matching context class toggles are found,
// returns FALSE, otherwise TRUE. Does not return toggles located at iter,
// only toggles after iter. Sets iter to the location of the toggle, or to the
// end of the buffer if no toggle is found.
...
//
// If highlight is TRUE, the text will be highlighted according
// to the syntax patterns specified in the SourceLanguage set with
...
// newline (if present in the file) is not inserted into the buffer. - when
// a SourceFileSaver saves the content of the buffer into a file, a trailing
...
//
// Note that a SourceLanguage affects not only the syntax highlighting,
// but also the [context classes][context-classes]. If you want to disable just
// the syntax highlighting, see gtk_source_buffer_set_highlight_syntax().
//
...
// view.
//
// Note that a SourceStyleScheme affects not only the syntax highlighting,
// but also other SourceView features such as highlighting the current line,
...
func (buffer *Buffer) SetUndoManager(manager UndoManagerer) {
	...
	_arg0 = (*C.GtkSourceBuffer)(unsafe.Pointer(coreglib.InternObject(buffer).Native()))
	if manager != nil {
		_arg1 = (*C.GtkSourceUndoManager)(unsafe.Pointer(coreglib.InternObject(manager).Native()))
	}
...
func (buffer *Buffer) bracketMatched(iter *gtk.TextIter, state BracketMatchType) {
	...
	C._gotk4_gtksource3_Buffer_virtual_bracket_matched(unsafe.Pointer(fnarg), _arg0, _arg1, _arg2)
	runtime.KeepAlive(buffer)
	runtime.KeepAlive(iter)
...
func (buffer *Buffer) redo() {
	...
	C._gotk4_gtksource3_Buffer_virtual_redo(unsafe.Pointer(fnarg), _arg0)
	runtime.KeepAlive(buffer)
}
...
func (buffer *Buffer) undo() {
	...
	C._gotk4_gtksource3_Buffer_virtual_undo(unsafe.Pointer(fnarg), _arg0)
	runtime.KeepAlive(buffer)
}
