...
// SetSettings: associate a SourceSearchSettings with the search context.
...
func (search *SearchContext) SetSettings(settings *SearchSettings) {
	...
	_arg0 = (*C.GtkSourceSearchContext)(unsafe.Pointer(coreglib.InternObject(search).Native()))
	if settings != nil {
		_arg1 = (*C.GtkSourceSearchSettings)(unsafe.Pointer(coreglib.InternObject(settings).Native()))
	}
