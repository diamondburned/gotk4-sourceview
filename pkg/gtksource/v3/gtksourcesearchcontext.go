...
//
func (search *SearchContext) Backward(iter *gtk.TextIter) (matchStart *gtk.TextIter, matchEnd *gtk.TextIter, ok bool) {
	...
	_cret = C.gtk_source_search_context_backward(_arg0, _arg1, &_arg2, &_arg3)
...
// Backward2 synchronous backward search. It is recommended to use the
// asynchronous functions instead, to not block the user interface. However, if
// you are sure that the buffer is small, this function is more convenient to
// use.
//
...
//    - ok: whether a match was found.
//
func (search *SearchContext) Backward2(iter *gtk.TextIter) (matchStart *gtk.TextIter, matchEnd *gtk.TextIter, hasWrappedAround bool, ok bool) {
	var _arg0 *C.GtkSourceSearchContext // out
	var _arg1 *C.GtkTextIter            // out
	var _arg2 C.GtkTextIter             // in
	var _arg3 C.GtkTextIter             // in
	...
	_cret = C.gtk_source_search_context_backward2(_arg0, _arg1, &_arg2, &_arg3, &_arg4)
	runtime.KeepAlive(search)
	runtime.KeepAlive(iter)
...
//    - matchEnd (optional): return location for end of match, or NULL.
//
func (search *SearchContext) BackwardFinish(result gio.AsyncResulter) (matchStart *gtk.TextIter, matchEnd *gtk.TextIter, goerr error) {
	var _arg0 *C.GtkSourceSearchContext // out
	...
	C.gtk_source_search_context_backward_finish(_arg0, _arg1, &_arg2, &_arg3, &_cerr)
	runtime.KeepAlive(search)
	...
	return _matchStart, _matchEnd, _goerr
}

// BackwardFinish2 finishes a backward search started with
// gtk_source_search_context_backward_async().
//
// See the documentation of gtk_source_search_context_backward2() for more
// details.
...
//      has wrapped around, or NULL.
//
func (search *SearchContext) BackwardFinish2(result gio.AsyncResulter) (matchStart *gtk.TextIter, matchEnd *gtk.TextIter, hasWrappedAround bool, goerr error) {
	var _arg0 *C.GtkSourceSearchContext // out
	var _arg1 *C.GAsyncResult           // out
	var _arg2 C.GtkTextIter             // in
	var _arg3 C.GtkTextIter             // in
	...
	C.gtk_source_search_context_backward_finish2(_arg0, _arg1, &_arg2, &_arg3, &_arg4, &_cerr)
	runtime.KeepAlive(search)
	runtime.KeepAlive(result)
...
//    - ok: whether a match was found.
//
func (search *SearchContext) Forward(iter *gtk.TextIter) (matchStart *gtk.TextIter, matchEnd *gtk.TextIter, ok bool) {
	var _arg0 *C.GtkSourceSearchContext // out
	var _arg1 *C.GtkTextIter            // out
	var _arg2 C.GtkTextIter             // in
	var _arg3 C.GtkTextIter             // in
	...
	_cret = C.gtk_source_search_context_forward(_arg0, _arg1, &_arg2, &_arg3)
	runtime.KeepAlive(search)
	runtime.KeepAlive(iter)
...
// Forward2 synchronous forward search. It is recommended to use the
// asynchronous functions instead, to not block the user interface. However, if
// you are sure that the buffer is small, this function is more convenient to
// use.
//
...
//    - ok: whether a match was found.
//
func (search *SearchContext) Forward2(iter *gtk.TextIter) (matchStart *gtk.TextIter, matchEnd *gtk.TextIter, hasWrappedAround bool, ok bool) {
	var _arg0 *C.GtkSourceSearchContext // out
	var _arg1 *C.GtkTextIter            // out
	var _arg2 C.GtkTextIter             // in
	var _arg3 C.GtkTextIter             // in
	...
	_cret = C.gtk_source_search_context_forward2(_arg0, _arg1, &_arg2, &_arg3, &_arg4)
	runtime.KeepAlive(search)
	runtime.KeepAlive(iter)
...
//    - matchEnd (optional): return location for end of match, or NULL.
//
func (search *SearchContext) ForwardFinish(result gio.AsyncResulter) (matchStart *gtk.TextIter, matchEnd *gtk.TextIter, goerr error) {
	var _arg0 *C.GtkSourceSearchContext // out
	var _arg1 *C.GAsyncResult           // out
	var _arg2 C.GtkTextIter             // in
	var _arg3 C.GtkTextIter             // in
	...
	C.gtk_source_search_context_forward_finish(_arg0, _arg1, &_arg2, &_arg3, &_cerr)
	runtime.KeepAlive(search)
	runtime.KeepAlive(result)
...
// ForwardFinish2 finishes a forward search started with
// gtk_source_search_context_forward_async().
//
// See the documentation of gtk_source_search_context_forward2() for more
// details.
...
//      has wrapped around, or NULL.
//
func (search *SearchContext) ForwardFinish2(result gio.AsyncResulter) (matchStart *gtk.TextIter, matchEnd *gtk.TextIter, hasWrappedAround bool, goerr error) {
	var _arg0 *C.GtkSourceSearchContext // out
	var _arg1 *C.GAsyncResult           // out
	var _arg2 C.GtkTextIter             // in
	var _arg3 C.GtkTextIter             // in
	...
	C.gtk_source_search_context_forward_finish2(_arg0, _arg1, &_arg2, &_arg3, &_arg4, &_cerr)
	runtime.KeepAlive(search)
	runtime.KeepAlive(result)
...
// Replace2 replaces a search match by another text. If match_start and
// match_end doesn't correspond to a search match, FALSE is returned.
//
...
func (search *SearchContext) Replace2(matchStart, matchEnd *gtk.TextIter, replace string, replaceLength int) error {
	...
	C.gtk_source_search_context_replace2(_arg0, _arg1, _arg2, _arg3, _arg4, &_cerr)
	runtime.KeepAlive(search)
	runtime.KeepAlive(matchStart)
	runtime.KeepAlive(matchEnd)
	runtime.KeepAlive(replace)
...
// SetSettings: associate a SourceSearchSettings with the search context. If
// settings is NULL, a new one will be created.
//
// The search context holds a reference to settings.
//
// Deprecated: The SourceSearchContext:settings property will become a
// construct-only property in a future version. Create a new SourceSearchContext
// instead, or change the SourceSearchSettings properties. When the
// SourceSearchContext:settings property will become construct-only, it will be
// possible to simplify some code that needed to listen to the notify::settings
// signal.
//
// The function takes the following parameters:
//
...
func (search *SearchContext) SetSettings(settings *SearchSettings) {
	...
	_arg0 = (*C.GtkSourceSearchContext)(unsafe.Pointer(externglib.InternObject(search).Native()))
	if settings != nil {
		_arg1 = (*C.GtkSourceSearchSettings)(unsafe.Pointer(externglib.InternObject(settings).Native()))
	}

	C.gtk_source_search_context_set_settings(_arg0, _arg1)
	runtime.KeepAlive(search)
	runtime.KeepAlive(settings)
}
