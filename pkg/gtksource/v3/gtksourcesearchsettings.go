...
// The match can span multiple words. See also gtk_text_iter_starts_word() and
...
//
// SourceSearchContext uses #GRegex when regex search
...
// SetWrapAround enables or disables the wrap around search. If wrap_around
// is TRUE, the forward search continues at the beginning of the buffer if no
